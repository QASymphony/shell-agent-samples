...
# Test Action (just writes to slack)
# eventTriggerUrl = "https://pulse.qas-labs.com/api/v1/webhooks/5a01e95fff85516fe58bbcf0/5a01eafcff85516fe58bbcf1/632b19d4-4158-4c59-9da1-00fda1a4f65f"

# Uploads raw Java Cucumber Results (in JSON format)
eventTriggerUrl = "https://pulse.qas-labs.com/api/v1/webhooks/5a01e95fff85516fe58bbcf0/5a01eafcff85516fe58bbcf1/5465059b-8605-4218-a254-6be7a5360b5f";
...
def HitPulseEndpoint(projectId, cycleId):
    ...
    with open('/Users/elise/Repos/cucumber-bdd/target/cucumber-report.json') as executedTestRuns:
